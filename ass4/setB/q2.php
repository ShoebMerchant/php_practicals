<h3>SET B</h3>
<p>
    2)Define a class Employee having <br />
    private members – id, name, department, salary.<br />
    Define parameterized constructors. <br />
    Create a subclass called “Manager” with private member bonus. <br />
    Create 6 objects of the Manager class and display the details
    of the manager having the maximum total salary (salary + bonus).
</p>
<hr />
